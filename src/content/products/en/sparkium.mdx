...
<Tabs>
  <TabsList>
    ...
    <TabsTab id="tab-details" controls="panel-details">
      Details
    </TabsTab>
    <TabsTab id="tab-settings" controls="panel-settings">
      Settings
    </TabsTab>
  </TabsList>
  ...
  <TabsPanel id="panel-details" labelledby="tab-details">
    Details content goes here.
  </TabsPanel>

  <TabsPanel id="panel-settings" labelledby="tab-settings">
