...
<Tabs>
  ...
  <TabsPanel id="panel-instructors" labelledby="tab-instructors" selected={true}>
    <StakeholderCard>
      ...
      <Image slot="image" src={Placeholder} alt="image" />
    </StakeholderCard>
  </TabsPanel>
  ...
  <TabsPanel id="panel-administrators" labelledby="tab-administrators">
    <StakeholderCard>
      <p slot="heading">
        Do you need to manage and set up courses for your institution, but find
        it difficult to keep track of changes and updates?
      </p>
      <p slot="body">
        Sparkium allows you to track, compare, and manage changes to your
        eLearning materials using version control tools like Git, making it
        easier to maintain and update your courses.
      </p>
      <Image slot="image" src={Placeholder} alt="image" />
    </StakeholderCard>
  </TabsPanel>
...
<Tabs>
  ...
  <TabsPanel id="panel-teams" labelledby="tab-teams">
    <StakeholderCard>
      ...
      <p slot="body">
        Sparkium helps corporate trainers to create, adapt, and reuse
        eLearning materials, even across teams and roles, making internal
        training easier to scale.
      </p>
      <Image slot="image" src={Placeholder} alt="image" />
    </StakeholderCard>
  </TabsPanel>
